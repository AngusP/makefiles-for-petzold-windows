# This is the Gnu makefile for the SysMets2 program found
# on p. 103 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = SysMets2.exe
...
SRCS = $(SRCDIR)/SysMets2.c

OBJS = $(ODIR)/SysMets2.o

HDRS = $(SRCDIR)/SysMets.h
