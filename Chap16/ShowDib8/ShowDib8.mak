# This is the Gnu makefile for the ShowDib8 program found
# on p. 909 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = ShowDib8.exe
...
SRCS = $(SRCDIR)/ShowDib8.c \
       ../ShowDib3/PackeDib.c \
       $(SRCDIR)/ShowDib8.rc

OBJS = $(ODIR)/ShowDib8.o \
       $(ODIR)/PackeDib.o \
       $(ODIR)/ShowDib8.res
...
# Petzold employs files from the ShowDib3 project for this ShowDib8 project.
