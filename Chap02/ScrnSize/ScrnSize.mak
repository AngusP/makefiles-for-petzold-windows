# This is the Gnu makefile for the ScrnSize program found
# on p. 37 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = ScrnSize.exe
...
SRCS = $(SRCDIR)/ScrnSize.c

OBJS = $(ODIR)/ScrnSize.o
