# This is the Gnu makefile for the GrafMenu program found
# on p. 689 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = GrafMenu.exe
...
SRCS = $(SRCDIR)/GrafMenu.c \
       $(SRCDIR)/GrafMenu.rc

OBJS = $(ODIR)/GrafMenu.o \
       $(ODIR)/GrafMenu.res
