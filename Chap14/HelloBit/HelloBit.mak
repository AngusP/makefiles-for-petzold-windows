# This is the Gnu makefile for the HelloBit program found
# on p. 677 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = HelloBit.exe
...
SRCS = $(SRCDIR)/HelloBit.c \
       $(SRCDIR)/HelloBit.rc

OBJS = $(ODIR)/HelloBit.o \
       $(ODIR)/HelloBit.res
