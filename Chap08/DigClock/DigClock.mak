# This is the Gnu makefile for the DigClock program found
# on p. 338 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = DigClock.exe
...
SRCS = $(SRCDIR)/DigClock.c

OBJS = $(ODIR)/DigClock.o
