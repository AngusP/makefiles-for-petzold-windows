# This is the Gnu makefile for the Justify2 program found
# on p. 1070 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = Justify2.exe
...
SRCS = $(SRCDIR)/Justify2.c \
       $(SRCDIR)/Justify2.rc

OBJS = $(ODIR)/Justify2.o \
       $(ODIR)/Justify2.res
