# This is the Gnu makefile for the ChosFont program found
# on p. 1048 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = ChosFont.exe
...
SRCS = $(SRCDIR)/ChosFont.c \
       $(SRCDIR)/ChosFont.rc

OBJS = $(ODIR)/ChosFont.o \
       $(ODIR)/ChosFont.res
