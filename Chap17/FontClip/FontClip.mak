# This is the Gnu makefile for the FontClip program found
# on p. 1093 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = FontClip.exe
...
SRCS = $(SRCDIR)/FontClip.c \
       ../EZTest/EZFont.c \
       ../EZTest/FontDemo.c \
       ../EZTest/FontDemo.rc

OBJS = $(ODIR)/FontClip.o \
       $(ODIR)/EZFont.o \
       $(ODIR)/FontDemo.o \
       $(ODIR)/FontDemo.res
