# This is the Gnu makefile for the FontOut2 program found
# on p. 1090 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = FontOut2.exe
...
SRCS = $(SRCDIR)/FontOut2.c \
       ../EZTest/EZFont.c \
       ../EZTest/FontDemo.c \
       ../EZTest/FontDemo.rc

OBJS = $(ODIR)/FontOut2.o \
       $(ODIR)/EZFont.o \
       $(ODIR)/FontDemo.o \
       $(ODIR)/FontDemo.res
