# This is the Gnu makefile for the FontFill program found
# on p. 1091 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = FontFill.exe
...
SRCS = $(SRCDIR)/FontFill.c \
       ../EZTest/EZFont.c \
       ../EZTest/FontDemo.c \
       ../EZTest/FontDemo.rc

OBJS = $(ODIR)/FontFill.o \
       $(ODIR)/EZFont.o \
       $(ODIR)/FontDemo.o \
       $(ODIR)/FontDemo.res
