# This is the Gnu makefile for the StokFont program found
# on p. 246 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = StokFont.exe
...
SRCS = $(SRCDIR)/StokFont.c

OBJS = $(ODIR)/StokFont.o
