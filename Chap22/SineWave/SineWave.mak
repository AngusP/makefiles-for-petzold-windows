# This is the Gnu makefile for the SineWave program found
# on p. 1290 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = SineWave.exe
...
SRCS = $(SRCDIR)/SineWave.c \
       $(SRCDIR)/SineWave.rc

OBJS = $(ODIR)/SineWave.o \
       $(ODIR)/SineWave.res
