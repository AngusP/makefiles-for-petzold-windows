# This is the Gnu makefile for the BachTocc program found
# on p. 1352 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = BachTocc.exe
...
SRCS = $(SRCDIR)/BachTocc.c

OBJS = $(ODIR)/BachTocc.o
