# This is the Gnu makefile for the RandRect program found
# on p. 200 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = RandRect.exe
...
SRCS = $(SRCDIR)/RandRect.c

OBJS = $(ODIR)/RandRect.o
