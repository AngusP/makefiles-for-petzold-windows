# This is the Gnu makefile for the LineDemo program found
# on p. 153 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = LineDemo.exe
...
SRCS = $(SRCDIR)/LineDemo.c

OBJS = $(ODIR)/LineDemo.o
