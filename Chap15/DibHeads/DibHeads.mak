# This is the Gnu makefile for the DibHeads program found
# on p. 746 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = DibHeads.exe
...
SRCS = $(SRCDIR)/DibHeads.c \
       $(SRCDIR)/DibHeads.rc

OBJS = $(ODIR)/DibHeads.o \
       $(ODIR)/DibHeads.res
