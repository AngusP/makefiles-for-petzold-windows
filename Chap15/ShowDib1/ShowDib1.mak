# This is the Gnu makefile for the ShowDib1 program found
# on p. 760 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = ShowDib1.exe
...
SRCS = $(SRCDIR)/ShowDib1.c \
       $(SRCDIR)/DibFile.c \
       $(SRCDIR)/ShowDib1.rc


OBJS = $(ODIR)/ShowDib1.o \
       $(ODIR)/DibFile.o \
       $(ODIR)/ShowDib1.res
