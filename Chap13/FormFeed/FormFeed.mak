# This is the Gnu makefile for the FormFeed program found
# on p. 617 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = FormFeed.exe
...
SRCS = $(SRCDIR)/FormFeed.c \
       ../Print1/GetPrnDC.c

OBJS = $(ODIR)/FormFeed.o \
       $(ODIR)/GetPrnDC.o
...
# Petzold employs files from the Print1 project for this FormFeed project.
