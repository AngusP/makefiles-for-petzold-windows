# This is the Gnu makefile for the DevCaps2 program found
# on p. 605 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = DevCaps2.exe
...
SRCS = $(SRCDIR)/DevCaps2.c \
       $(SRCDIR)/DevCaps2.rc

OBJS = $(ODIR)/DevCaps2.o \
       $(ODIR)/DevCaps2.res
