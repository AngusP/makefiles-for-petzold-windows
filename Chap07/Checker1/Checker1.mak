# This is the Gnu makefile for the Checker1 program found
# on p. 288 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = Checker1.exe
...
SRCS = $(SRCDIR)/Checker1.c

OBJS = $(ODIR)/Checker1.o
