# This is the Gnu makefile for the ClipText program found
# on p. 575 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = ClipText.exe
...
SRCS = $(SRCDIR)/ClipText.c \
       $(SRCDIR)/ClipText.rc

OBJS = $(ODIR)/ClipText.o \
       $(ODIR)/ClipText.res
