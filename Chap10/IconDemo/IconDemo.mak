# This is the Gnu makefile for the IconDemo program found
# on p. 419 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = IconDemo.exe
...
SRCS = $(SRCDIR)/IconDemo.c \
       $(SRCDIR)/IconDemo.rc

OBJS = $(ODIR)/IconDemo.o \
       $(ODIR)/IconDemo.res
