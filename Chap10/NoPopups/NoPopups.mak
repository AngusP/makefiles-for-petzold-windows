# This is the Gnu makefile for the NoPopups program found
# on p. 464 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = NoPopups.exe
...
SRCS = $(SRCDIR)/NoPopups.c \
       $(SRCDIR)/NoPopups.rc

OBJS = $(ODIR)/NoPopups.o \
       $(ODIR)/NoPopups.res
