# This is the Gnu makefile for the MenuDemo program found
# on p. 445 of the book "Programming Windows Fifth Edition"
# by Charles Petzold.

# John Kopplin   www.computersciencelab.com

PROGRAM = MenuDemo.exe
...
SRCS = $(SRCDIR)/MenuDemo.c \
       $(SRCDIR)/MenuDemo.rc

OBJS = $(ODIR)/MenuDemo.o \
       $(ODIR)/MenuDemo.res
